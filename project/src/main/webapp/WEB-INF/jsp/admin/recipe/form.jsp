                    ...
                    <div class="col-xs-12">
                        <spring:bind path="ingredients">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                ...
                                <button type="button" class="btn btn-default btn-xs" data-role="addIngredient">Sel</button>
                                <button type="button" class="btn btn-default btn-xs" data-role="addIngredient">Poivre</button>
                                <div id="ingredients">
