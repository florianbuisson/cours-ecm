...
<body>
    <fragments:header headerName="recettes" />
    ...
    <div class="container">
        ...
        <form class="form-inline">
            <div class="form-group">
                ...
                <input type="text" data-role="tags" data-service-url="/tags.json" data-limit="1" class="form-control" id="tag" placeholder="Tag" name="tag" value="${fn:escapeXml(tagSearch.getTag())}" style="width: 200px;">
            </div>
